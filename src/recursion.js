...
// fibonacci recursive: data & tests
...
var capitalizeFirst = function(array) {
  ...
  capsFirstArr.push(array[0].charAt(0).toUpperCase() + array[0].slice(1));
  return capsFirstArr.concat(capitalizeFirst(array.slice(1)));
};
// capitalizeFirst recursively: data & tests
...
var flatten = function(array) {
  return arr.reduce((flatArr, i) => {
    if (Array.isArray(i)) {
      return flatArr.concat(flatten(i));
    }
  return flatArr.concat(i)
  }, []);
};
// flatten recursively: data & tests
